import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, getCookie, getHeader, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText, H3Error } from 'file:///home/moriel/code/projects/technically.lol/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import fs, { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import _RemarkEmoji from 'file:///home/moriel/code/projects/technically.lol/node_modules/remark-emoji/index.js';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///home/moriel/code/projects/technically.lol/node_modules/defu/dist/defu.mjs';
import { html as html$2 } from 'file:///home/moriel/code/projects/technically.lol/node_modules/satori-html/dist/index.js';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withoutTrailingSlash, withLeadingSlash, withBase, withoutLeadingSlash, isRelative, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file:///home/moriel/code/projects/technically.lol/node_modules/ufo/dist/index.mjs';
import sizeOf from 'file:///home/moriel/code/projects/technically.lol/node_modules/image-size/dist/index.js';
import { consola, createConsola } from 'file:///home/moriel/code/projects/technically.lol/node_modules/consola/dist/index.mjs';
import { Launcher } from 'file:///home/moriel/code/projects/technically.lol/node_modules/chrome-launcher/dist/index.js';
import playwrightCore from 'file:///home/moriel/code/projects/technically.lol/node_modules/playwright-core/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/moriel/code/projects/technically.lol/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, parse as parse$1, uneval } from 'file:///home/moriel/code/projects/technically.lol/node_modules/devalue/index.js';
import destr, { destr as destr$1 } from 'file:///home/moriel/code/projects/technically.lol/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///home/moriel/code/projects/technically.lol/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///home/moriel/code/projects/technically.lol/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin, createHeadCore } from 'file:///home/moriel/code/projects/technically.lol/node_modules/unhead/dist/index.mjs';
import { isVNode, toValue, version, unref } from 'file:///home/moriel/code/projects/technically.lol/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file:///home/moriel/code/projects/technically.lol/node_modules/@unhead/shared/dist/index.mjs';
import { createHooks } from 'file:///home/moriel/code/projects/technically.lol/node_modules/hookable/dist/index.mjs';
import { $fetch as $fetch$1, createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/moriel/code/projects/technically.lol/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/moriel/code/projects/technically.lol/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///home/moriel/code/projects/technically.lol/node_modules/klona/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///home/moriel/code/projects/technically.lol/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///home/moriel/code/projects/technically.lol/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/moriel/code/projects/technically.lol/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/moriel/code/projects/technically.lol/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///home/moriel/code/projects/technically.lol/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/moriel/code/projects/technically.lol/node_modules/errx/dist/index.js';
import devalue from 'file:///home/moriel/code/projects/technically.lol/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { defineWebPage } from 'file:///home/moriel/code/projects/technically.lol/node_modules/@unhead/schema-org/dist/index.mjs';
import { hash } from 'file:///home/moriel/code/projects/technically.lol/node_modules/ohash/dist/index.mjs';
import { extname, resolve as resolve$1 } from 'file:///home/moriel/code/projects/technically.lol/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///home/moriel/code/projects/technically.lol/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///home/moriel/code/projects/technically.lol/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///home/moriel/code/projects/technically.lol/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///home/moriel/code/projects/technically.lol/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/moriel/code/projects/technically.lol/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/moriel/code/projects/technically.lol/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///home/moriel/code/projects/technically.lol/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///home/moriel/code/projects/technically.lol/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file:///home/moriel/code/projects/technically.lol/node_modules/slugify/slugify.js';
import remarkParse from 'file:///home/moriel/code/projects/technically.lol/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///home/moriel/code/projects/technically.lol/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///home/moriel/code/projects/technically.lol/node_modules/remark-mdc/dist/index.mjs';
import remarkGFM from 'file:///home/moriel/code/projects/technically.lol/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///home/moriel/code/projects/technically.lol/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///home/moriel/code/projects/technically.lol/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///home/moriel/code/projects/technically.lol/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///home/moriel/code/projects/technically.lol/node_modules/rehype-raw/index.js';
import { detab } from 'file:///home/moriel/code/projects/technically.lol/node_modules/detab/index.js';
import { toString } from 'file:///home/moriel/code/projects/technically.lol/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///home/moriel/code/projects/technically.lol/node_modules/github-slugger/index.js';
import { readFile } from 'node:fs/promises';
import { diffLines } from 'file:///home/moriel/code/projects/technically.lol/node_modules/diff/lib/index.mjs';
import MagicString from 'file:///home/moriel/code/projects/technically.lol/node_modules/magic-string/dist/magic-string.es.mjs';
import Fuse from 'file:///home/moriel/code/projects/technically.lol/node_modules/fuse.js/dist/fuse.mjs';
import lruCacheDriver from 'file:///home/moriel/code/projects/technically.lol/node_modules/unstorage/drivers/lru-cache.mjs';
import { createGenerator } from 'file:///home/moriel/code/projects/technically.lol/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///home/moriel/code/projects/technically.lol/node_modules/@unocss/preset-wind/dist/index.mjs';
import { Resvg } from 'file:///home/moriel/code/projects/technically.lol/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///home/moriel/code/projects/technically.lol/node_modules/satori/dist/index.js';
...
const _3UQhYnUjcR = (function(nitro) {
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "nuxt-link-checker": {
      ...
      "rootDir": "/home/moriel/code/projects/technically.lol",
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/home/moriel/code/projects/technically.lol/.nuxt/cache/nuxt-og-image@4.0.2/_fonts"},{"baseName":"server","dir":"/home/moriel/code/projects/technically.lol/server/assets"}];
...
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/moriel/code/projects/technically.lol/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/moriel/code/projects/technically.lol/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/moriel/code/projects/technically.lol","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/moriel/code/projects/technically.lol/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/moriel/code/projects/technically.lol/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/moriel/code/projects/technically.lol/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/moriel/code/projects/technically.lol/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _Dvjn6Ce2YK = defineNitroPlugin(async (nitro) => {
...
const _P1QYRYL5Mu = defineNitroPlugin(async (nitroApp) => {
...
const _zIKOcKUGyn = defineNitroPlugin(async (nitroApp) => {
...
const _2jVo9Rqxib = defineNitroPlugin((nitroApp) => {
...
const componentNames = [{"hash":"eQ6ZSzmuSi","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/home/moriel/code/projects/technically.lol/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"urK4vBHedV","pascalName":"Frame","kebabName":"frame","path":"/home/moriel/code/projects/technically.lol/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"25HYRU2CwN","pascalName":"Nuxt","kebabName":"nuxt","path":"/home/moriel/code/projects/technically.lol/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"QQP0wDr3q7","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/home/moriel/code/projects/technically.lol/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"Ti15ewGcfK","pascalName":"Pergel","kebabName":"pergel","path":"/home/moriel/code/projects/technically.lol/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"mpvrSL80TM","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/home/moriel/code/projects/technically.lol/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"PdTiW3yQ0N","pascalName":"UnJs","kebabName":"un-js","path":"/home/moriel/code/projects/technically.lol/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"dxElbCCT8d","pascalName":"Wave","kebabName":"wave","path":"/home/moriel/code/projects/technically.lol/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"GANho8xkgv","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/home/moriel/code/projects/technically.lol/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
...
const _x6EpPVmAUW = defineNitroPlugin((nitroApp) => {
...
const _0dYgAAdn06 = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _ljlPuL4S9Q = defineNitroPlugin((nitroApp) => {
...
const _06wNuG = defineEventHandler(async (e) => {
...
const _soGqFf = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _PusD1W = defineEventHandler(async (e) => {
...
const _tzEg8p = defineEventHandler(async (e) => {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/moriel/code/projects/technically.lol/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _49bajF = defineEventHandler(async (e) => {
  const content = [];
  try {
...
const _wDA564 = defineEventHandler(async (e) => {
...
const _7cZ3qi = defineEventHandler(async (e) => {
...
const _HBAwcL = defineEventHandler(async (e) => {
...
const _QZR03L = defineEventHandler(async (e) => {
...
const _AW7q35 = defineEventHandler(async (e) => {
...
const _J5A4iv = defineEventHandler(async (e) => {
...
const _UZXDf7 = defineEventHandler(async (e) => {
  const nitroOrigin = useNitroOrigin(e);
  return {
    nitroOrigin,
...
const _cRp0dC = defineEventHandler(async (e) => {
...
const _8shigJ = defineCachedEventHandler(async (e) => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"] || {};
  const linkDb = [
    ...pagePaths
  ];
...
const _a2oiYE = defineEventHandler(async (e) => {
  return {
...
const _WUS3eS = defineEventHandler(async (e) => {
...
const _RPvLnr = defineEventHandler(async (event) => {
...
const _5VaH2r = defineEventHandler(async (event) => {
...
const _bc0pzB = defineEventHandler(async (event) => {
  const { getContentQuery } = await Promise.resolve().then(function () { return query; });
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _lazy_uy3YKZ = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_HOWXb0 = () => Promise.resolve().then(function () { return font$1; });
const _lazy_GtW94n = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_TGQ12Q = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_uy3YKZ, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _06wNuG, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _soGqFf, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _PusD1W, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _tzEg8p, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/nuxt-content.json', handler: _49bajF, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _wDA564, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _7cZ3qi, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _HBAwcL, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _QZR03L, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _AW7q35, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _J5A4iv, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_HOWXb0, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_GtW94n, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_TGQ12Q, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_TGQ12Q, lazy: true, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _UZXDf7, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/inspect', handler: _cRp0dC, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _8shigJ, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _a2oiYE, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _WUS3eS, lazy: false, middleware: true, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _RPvLnr, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _RPvLnr, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _RPvLnr, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _5VaH2r, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _bc0pzB, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _bc0pzB, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _bc0pzB, lazy: false, middleware: false, method: "get" },
  { route: '/_fonts/**', handler: _lazy_uy3YKZ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_uy3YKZ, lazy: true, middleware: false, method: undefined }
];
...
async function useSharp() {
  sharpInstance.instance = sharpInstance.instance || await import('file:///home/moriel/code/projects/technically.lol/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
  return sharpInstance.instance;
}
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await import('file:///home/moriel/code/projects/technically.lol/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
...
const getClientManifest = () => import('file:///home/moriel/code/projects/technically.lol/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/moriel/code/projects/technically.lol/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
